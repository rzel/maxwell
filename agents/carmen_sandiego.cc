...
class CarmenSandiego : public ApplicationImplBase,
 ...
 public:
  ...
  void OnInitialize() override {
    ContextServicePtr cxs;
    ConnectToService(shell(), "mojo:context_service", GetProxy(&cxs));
    cxs->RegisterContextAgent("agents/carmen_sandiego", GetProxy(&cx_client_));
    ...
    cx_client_->RegisterPublisher("/location/region", "json:string",
  ...
  void StartPublishing(InterfaceHandle<ContextPublisherLink> link) override {
    ...
    cx_client_->Subscribe("/location/gps", "https://developers.google.com/maps/"
 ...
 private:
  ContextAgentClientPtr cx_client_;
